<?php
namespace TextColumnBlock\Site\BlockLayout;
 ...
 */
class TextColumnBlock extends AbstractBlockLayout
{
    /**
    ...
    {
        return 'Libis - Text blocks (1,2 or 3)'; // @translate
    }
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/text-column-block-form', [
            'block' => $block,
        ]);
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      return $view->partial('common/block-layout/text-column-block', [
        'block' => $block,
