<?php
namespace ImageOnlyBlock\Site\BlockLayout;
 ...
 */
class ImageOnlyBlock extends AbstractBlockLayout
{
    /**
    ...
    {
        return 'CAG - Image only (full size)'; // @translate
    }
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/image-only-block-form', [
            'block' => $block,
        ]);
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      return $view->partial('common/block-layout/image-only-block', [
        'block' => $block,
